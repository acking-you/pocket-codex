...
| Turn controls | Auto approval review by default, separate manual/read-only/full-access modes, capability-gated Fast, and running-turn supplements alongside the default next-turn queue |
