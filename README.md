...
| Native image generation | live generation/loading feedback, inline previews and desktop saving, retryable remote artifact reads, and restored/monitored results; uses the external Codex image tool ([verification](docs/native-image-generation.md)) |
